    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='ai_attendance_system.Faculty')),
                ('student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='ai_attendance_system.Student')),
            ],
        ),
    ]
