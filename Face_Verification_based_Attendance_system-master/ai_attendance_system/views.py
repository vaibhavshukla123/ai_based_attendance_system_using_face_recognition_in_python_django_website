...
def home(request):
    ...
    return render(request, 'ai_attendance_system/home.html', context)
...
def loginPage(request):
    ...
    context = {}
    return render(request, 'ai_attendance_system/login.html', context)
...
def updateStudentRedirect(request):
    ...
    if request.method == 'POST':
        try:
            ...
            return redirect('home')
    return render(request, 'ai_attendance_system/student_update.html', context)
...
def facultyProfile(request):
    ...
    context = {'form':form}
    return render(request, 'ai_attendance_system/facultyForm.html', context)
...
def addStudent(request):
    ...
    context = {'studentForm':studentForm}
    return render(request, 'ai_attendance_system/add_student.html', context)
...
def studentUpdate(request):
    ...
    if request.method == 'POST':
        try:
            ...
            messages.error(request, 'Student Not Found')
            return redirect('home')
    return render(request, 'ai_attendance_system/update_student.html', context)
...
def gen(camera):
    ...
    base_dir = os.getcwd()
    image_dir = os.path.join(base_dir,"{}\{}\{}\{}\{}\{}".format('static','images','Student_Images',formdetails['branch'],formdetails['year'],formdetails['section']))
...
#     return render(request, 'ai_attendance_system/videoFeed.html')
...
def saveAttendance(request):
    ...
    return JsonResponse({'status':True,'message':'Attendance recorded', 'url': 'http://127.0.0.1:8000'})
    # return render(request, 'ai_attendance_system/attendance.html', context) 
